...
public final class listaradmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Crud-Diego-ListarAdmin</title>\n");
      out.write("    </head>\n");
      out.write("\n");
      out.write("    <body>\n");
      ...
      out.write("                <div class=\"panel-heading text-center panel-color\"><h2>TABLA EJERCICIOS</h2></div>\n");
      out.write("                ");
      ...
      out.write("\n");
      out.write("\n");
      out.write("                <table class=\"table table-striped\" id=\"listar\">\n");
      ...
      out.write("                            <td><input type=\"text\" name=\"ejercicios\" size=\"30\"></td>\n");
      out.write("                            <td>    \n");
      out.write("                                <select class=\"form-control\" since=\"10\">\n");
      ...
      out.write("                                </select>\n");
      out.write("                            </td>\n");
      out.write("                            <td><input type=\"text\" name=\"dia\" size=\"6\"></td>\n");
      out.write("                            <td><button type=\"submit\" value=\"Añadir\" class=\"color-boton btn\"><span class=\"glyphicon glyphicon-plus\"></span> Añadir</button></td><td></td></tr>           \n");
      out.write("                    </form>\n");
      out.write("                    ");
                    while (listado.next()) {
                        out.println("<tr><td>");
      ...
      out.write("\">\n");
      out.write("                            <button type=\"submit\"  class=\"color-boton btn\" hrf=\"modifica.jsp?usuariooline=");
      ...
      out.print(listado.getString("CodTablaEjercicio"));
      out.write("\"/>\n");
      out.write("                            <button type=\"submit\" class=\"color-boton btn\"><span class=\"glyphicon glyphicon-remove\"></span> Eliminar</button>\n");
      out.write("                        </form>\n");
      out.write("                    </td></tr>\n");
      out.write("                    ");
      ...
      out.write("            <br><br>\t\t\t\n");
      out.write("            <div class=\"panel panel-redondeado\">\n");
      out.write("                <div class=\"panel-heading text-center panel-color\"><h2>USUARIOS</h2></div>\n");
      out.write("                ");
                  ...
                  ResultSet listado2 = s2.executeQuery("SELECT * FROM Usuario;");
                  
                
      out.write("\n");
      out.write("\n");
      out.write("                <table class=\"table table-striped\" id=\"listar\">\n");
      out.write("                    <tr><th>CODIGO</th><th>NOMBRE</th><th>CONTRASEÑA</th></tr>\n");
      out.write("                    <form method=\"get\" action=\"creausuario.jsp\">\n");
      out.write("                        <tr><td><input type=\"text\" name=\"codigousuario\" size=\"2\"></td>\n");
      out.write("                            <td><input type=\"text\" name=\"nombreusuario\" size=\"15\"></td>\n");
      out.write("                            <td><input type=\"text\" name=\"contraseniausuario\" size=\"30\"></td>\n");
      out.write("                            <td><button type=\"submit\" value=\"Añadir\" class=\"color-boton btn\"><span class=\"glyphicon glyphicon-plus\"></span> Añadir</button></td><td></td></tr>           \n");
      out.write("                    </form>\n");
      out.write("                    ");
 while (listado2.next()) {
                        if (!listado2.getString("NomUsuario").equals("admin")){
                            out.println("<tr><td>");
                            out.println(listado2.getString("CodUsuario") + "</td>");
                            out.println("<td>" + listado2.getString("NomUsuario") + "</td>");
                            out.println("<td>" + listado2.getString("ConUsuario") + "</td>");
                    
      out.write("\n");
      out.write("                    <td>\n");
      out.write("                        <form method=\"get\" action=\"borrausuario.jsp\">\n");
      out.write("                            <input type=\"hidden\" name=\"codigousuario\" value=\"");
      out.print(listado2.getString("CodUsuario"));
      out.write("\"/>\n");
      out.write("                            <button type=\"submit\" class=\"color-boton btn\"><span class=\"glyphicon glyphicon-remove\"></span> Eliminar</button>\n");
      out.write("                        </form>\n");
      out.write("                    </td></tr>\n");
